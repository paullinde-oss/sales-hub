...
function QuotesTab({quotes,activeQuote,searchQ,setSearchQ,productsCAD,productsUSD,effectiveProductsUSD,createNewQuote,setActiveQuote,saveQuote,editQuote,openEmailModal,generatePDF,deleteConfirm,setDeleteConfirm,deleteQuote,duplicateQuote,quoteSort,setQuoteSort,closeConfirm,setCloseConfirm,exchangeRate,T}) {
  return (
    <div style={{display:"flex",height:"100%",overflow:"hidden",flexDirection:"column"}}>
      {/* Top action bar */}
      <div style={{borderBottom:"1px solid #181818",padding:"8px 16px",background:"#0a0a0a",flexShrink:0}}>
        ...
        {!activeQuote
          ? <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"100%",gap:16}}>
              ...
              <div style={{textAlign:"center"}}>
                ...
                <div style={{fontSize:11,color:T.muted||"#999"}}>Select one from the list</div>
              </div>
            </div>
...
function ProductEditRow({row,setRow,onSave,onCancel,availableSubCats=[],currentSubCat="",onSubCatChange}) {
  ...
  return (
    <tr style={{verticalAlign:"top"}}>
      <td style={{paddingTop:6}}><input {...f("sku")} placeholder="SKU" style={{width:"100%",fontSize:11,height:26,fontFamily:"monospace",color:"#c8a96e",fontFamily:"'Helvetica Neue',Helvetica,Arial,sans-serif"}}/></td>
      <td><input {...f("product")} placeholder="Product name"/></td>
      ...
      <td><input {...f("pkg")} placeholder="Pkg"/></td>
      <td><input {...f("pallet")} placeholder="Pallet"/></td>
      <td><input {...f("truckQty")} placeholder="Truck"/></td>
      <td><input {...f("price","number")} step="0.01" placeholder="Price"/></td>
      <td><input {...f("palletPrice","number")} step="0.01" placeholder="Pallet"/></td>
      <td><input {...f("prepaid","number")} step="0.01" placeholder="Prepaid"/></td>
      <td><input {...f("prepaidPallet","number")} step="0.01" placeholder="P.Pallet"/></td>
      <td><input {...f("truckPrice","number")} step="0.01" placeholder="Truck"/></td>
