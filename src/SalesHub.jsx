...
const APP_VERSION = "v5.3 — Jul 2026";
      ...
      <td style={{minWidth:220}}>
        ...
        {onSubCatChange && (
          <div style={{marginTop:6,display:"flex",alignItems:"center",gap:6}}>
            <span style={{fontSize:9,color:"var(--muted,#888)",letterSpacing:".06em",textTransform:"uppercase",whiteSpace:"nowrap"}}>Sub-cat:</span>
            <select value={currentSubCat||""} onChange={e=>onSubCatChange(e.target.value)}
              style={{flex:1,fontSize:11,height:24,background:"var(--input-bg)",border:"1px solid var(--border-light)",color:"var(--text)"}}>
