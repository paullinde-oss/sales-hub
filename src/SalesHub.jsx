...
function QuotesTab({quotes,activeQuote,searchQ,setSearchQ,productsCAD,productsUSD,effectiveProductsUSD,createNewQuote,setActiveQuote,saveQuote,editQuote,openEmailModal,generatePDF,deleteConfirm,setDeleteConfirm,deleteQuote,duplicateQuote,quoteSort,setQuoteSort,closeConfirm,setCloseConfirm,exchangeRate,T}) {
  return (
    <div style={{display:"flex",flexDirection:"column",height:"100%",overflow:"hidden"}}>
      ...
      <div style={{padding:"8px 14px",borderBottom:`1px solid ${T.border||"#181818"}`,background:T.headerBg||"#0a0a0a",flexShrink:0,display:"flex",alignItems:"center",gap:10}}>
        <button className="btn-gold" style={{fontSize:12,padding:"7px 22px"}} onClick={createNewQuote}>+ Create New Quote</button>
      </div>
        ...
        {!activeQuote
          ? <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"100%",gap:16}}>
              ...
              <div style={{textAlign:"center"}}>
                ...
                <div style={{fontSize:11,color:T.muted||"#999"}}>Select a quote from the list or create a new one above</div>
              </div>
            </div>
